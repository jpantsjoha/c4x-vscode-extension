...
>
> **Status (2025-12-13)**: ✅ **v1.1.9 STABLE** - Featuring Edge-to-Edge Rendering & Verified Cloud Icons.
...
- 🧠 **Intelligent Architecture (Gemini AI)** - Your pair programmer for diagrams.
  ...
  - *Enterprise Ready*: Supports Vertex AI keys for zero-data retention.
  - **[📘 Read the Gemini AI Guide](./docs/GEMINI_GUIDE.md)**
...
- 🖼️ **Custom Local Icons** - Support for `$sprite="./assets/logo.png"` (Base64 embedded) for infinite extensibility.
