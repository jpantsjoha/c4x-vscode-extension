...
- [x] "Generate Diagram" command produces valid, lint-free code. (v1.1.0)
- [ ] Analyzer reports structural insights with actionable fixes.

## 📅 Timeline
- **Start**: December 2025 (v1.1.0)
- **Status**: Generative features SHIPPED. Agent DSL pending.
- **Duration**: Ongoing